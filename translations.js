(() => {
  const english = new Map([
    ...
    ["opérationnel en 7 jours.", "ready to use in 7 days."],
    ["FikolasAI met en place un Agent IA adapté à votre activité, vos tâches et vos objectifs. Pas une démo gadget. Un agent concret, prêt à utiliser, pour gagner du temps et retirer une friction métier dès la première semaine.", "FikolasAI builds an AI Agent around your business, tasks and goals. Not a gadget demo. A practical, ready-to-use agent designed to save time and remove one operational friction from the first week."],
    ...
    ["Promesse", "Promise"],
    ["Votre Agent IA mis en place en moins de 7 jours pour 1000€ HT.", "Your AI Agent set up in under 7 days for €1,000 excl. VAT."],
    ...
    ["L'offre phare est volontairement simple, rapide et désirable : un Agent IA à vous, livré sous 7 jours, pour 1000€ HT. Les offres Academy et Studio restent disponibles pour aller plus loin.", "The main offer is deliberately simple and fast: your own AI Agent, delivered within 7 days for €1,000 excl. VAT. Academy and Studio remain available when you want to go further."],
    ["Offre principale", "Main offer"],
    ["Votre Agent IA", "Your AI Agent"],
    ["Votre propre Agent IA opérationnel en moins de 7 jours. Une offre simple, rare et faite pour passer à l'action tout de suite.", "Your own AI Agent, operational in under 7 days. A simple offer designed to help you take action immediately."],
    ...
    ["HT · livraison sous 7 jours", "excl. VAT · delivered within 7 days"],
    ["inclus", "included"],
    ...
    ["En moins de 7 jours, votre agent est prêt.", "Your agent is ready in under 7 days."],
    ...
    ["Qu'est-ce que je reçois pour 1000€ HT ?", "What do I receive for €1,000 excl. VAT?"],
    ["Votre propre Agent IA, cadré autour d'un cas d'usage clair, testé sur vos exemples et livré avec une prise en main simple.", "Your own AI Agent, scoped around one clear use case, tested on your examples and delivered with straightforward onboarding."],
    ["Est-ce vraiment livré en moins de 7 jours ?", "Is it really delivered in under 7 days?"],
    ["Oui. L'offre est volontairement cadrée pour livrer vite un premier agent utile, sans transformer cela en grand projet.", "Yes. The offer is deliberately scoped to deliver a useful first agent quickly without turning it into a large project."],
